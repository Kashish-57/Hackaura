    ...
    try {
      ...
      if (conversations && conversations.length > 0) {
        ...
        const initialMessage = {
          id: 1,
          sender: "ai",
          text: t("aiCompanion.chat.initialMessage"),
          ...
          <div className="flex items-center space-x-4">
            <Link to="/">
              <Button variant="ghost" size="sm">
                ...
                {t("aiCompanion.backToDashboard")}
              </Button>
            </Link>
            <h1 className="text-2xl font-bold text-primary">{t("aiCompanion.title")}</h1>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-6 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold mb-4">{t("aiCompanion.title")}</h1>
            <p className="text-xl text-muted-foreground">
              {t("aiCompanion.pageDescription")}
            </p>
          </div>

          <Card className="bg-card/50 backdrop-blur-sm border-primary/20 h-[600px] flex flex-col">
            <CardHeader>
              <CardTitle>{t("aiCompanion.chat.title")}</CardTitle>
              <CardDescription>
                {t("aiCompanion.chat.description")}
              </CardDescription>
            </CardHeader>
